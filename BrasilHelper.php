...
class BrasilHelper
{
     ...
     *
     */
     public static function estado($uf){
       return new Estado($uf);
     }
...
class Estado{
    ...
    public function __construct($uf){
        $this->setCidades($this->arrayCidades[strtoupper($uf)]);
    }

    public function setCidades($val){
      $this->cidades = $val;
    }
